...
export const consultations = mysqlTable("consultations", {
  ...
  // ✅ 추가 최종학력
  finalEducation: varchar("finalEducation", { length: 100 }).notNull().default(""),
...
export const students = mysqlTable("students", {
  ...
  status: mysqlEnum("studentStatus", ["등록", "종료"]).default("등록").notNull(),
...
institutionId: int("institutionId"),
  ...
  approvalStatus: mysqlEnum("approvalStatus", ["대기", "승인", "불승인"]).default("대기").notNull(),
...
export const plans = mysqlTable("plans", {
  ...
  practiceStatus: mysqlEnum("practiceStatus", ["미섭외", "섭외중", "섭외완료"]).default("미섭외"),
