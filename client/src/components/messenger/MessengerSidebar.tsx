...
onToggleNotification,
 ...
 return (
 <aside className="flex h-full min-h-0 border-r border-black/5 bg-transparent">
 <div className="flex w-[72px] shrink-0 flex-col items-center justify-between border-r border-black/5 bg-transparent py-4">
 ...
 <div className="border-b border-black/5 bg-transparent px-4 py-4">
 {currentUser && (
